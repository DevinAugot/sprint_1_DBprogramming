...
SELECT a.airport_id, ac.aircraft_id from airports a, aircraft ac, airport_aircraft ap
where a.airport_id = ap.airport_id
and ac.aircraft_id = ap.aircraft_id
-- shows every airport aircraft with id # 3 had landed and taken off from -- 
and ap.aircraft_id = 3
